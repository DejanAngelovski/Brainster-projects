...
const LogOnPage: NextPage = () => {
  return (
    <div className="pt-5 login-familyFont">
      <div className="row">
      ...
      <div className="row pt-5 pb-3">
        <div className="col-12 d-flex justify-content-center ">
          <Link href={`/logOn/register`} className="login-links py-2 text-dark">
      ...
      <div className="row pb-3">
        <div className="col-12 d-flex justify-content-center ">
          <Link
            ...
            className="login-links py-2 text-dark"
          >
      ...
      <div className="row pb-3">
        <div className="col-12 d-flex justify-content-center ">
          <Link
            href={`https://www.facebook.com/?locale=mk_MK`}
            className="login-links py-2 text-dark"
          >
